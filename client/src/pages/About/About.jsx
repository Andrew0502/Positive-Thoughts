            ...
            <div className="container">
                <div className="row">
                    <section className="col-sm-12">
                        ...
                        <h4 className="border">Welcome to Positive Thoughts! Positive Thoughts is an app made for the you to use to help deal with the struggles of the world. Sometimes life gets away from us and we find ourselves lying in bed all day long not knowing where the day went.
